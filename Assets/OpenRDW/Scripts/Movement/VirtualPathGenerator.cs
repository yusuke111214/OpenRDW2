...
public class VirtualPathGenerator
{
    ...
    public static bool CheckValid(SingleSpace space, Vector2 pos, float dirInDegrees, float dis)
    {
        Vector2 newpos = pos + Utilities.RotateVector(new Vector2(0, 1), dirInDegrees) * dis;
