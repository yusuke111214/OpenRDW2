...
public class RedirectionManager : MonoBehaviour
{
    ...
    public enum RedirectorChoice { None, S2C, S2O, Zigzag, ThomasAPF, S2G_WithAttraction, MessingerAPF, DynamicAPF, DeepLearning, PassiveHapticAPF, SeparateSpace };
    ...
    public System.Type RedirectorChoiceToRedirector(RedirectorChoice redirectorChoice)
    {
        switch (redirectorChoice)
        {
            ...
            case RedirectorChoice.S2G_WithAttraction:
                return typeof(S2G_WithAttraction_Redirector);
    ...
    public static RedirectorChoice RedirectorToRedirectorChoice(System.Type redirector)
    {
        ...
        else if (redirector.Equals(typeof(S2G_WithAttraction_Redirector)))
            return RedirectorChoice.S2G_WithAttraction;
    ...
    public static System.Type DecodeRedirector(string s)
    {
        switch (s.ToLower())
        {
            ...
            case "thomasapf":
                return typeof(ThomasAPF_Redirector);
            case "s2g_withattraction":
            case "s2gwithattraction":
                return typeof(S2G_WithAttraction_Redirector);
            case "messingerapf":
                return typeof(MessingerAPF_Redirector);
            case "dynamicapf":
